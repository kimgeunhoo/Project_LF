...
namespace BSPDungeonGenrator.Rendering
{
    ...
    public class BspDrawer : MonoBehaviour
    {
        ...
        public void OnDrawLine(OldDungeonContext ctx, DungeonData dungeonData, Transform lineHolder)
        {
        ...
        public void OnDrawRectangle(OldDungeonContext ctx, DungeonData dungeonData, Transform lineHolder)
        {
        ...
        public void OnDrawLeafRectangle(OldDungeonContext ctx, DungeonData dungeonData, Transform lineHolder)
        {
            if (ctx == null || dungeonData == null || lineHolder == null || ctx.Root == null)
                return;
            this.ctx = ctx;
