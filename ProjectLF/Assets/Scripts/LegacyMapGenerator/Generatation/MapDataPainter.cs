...
namespace BSPDungeonGenrator.Generation
{
    public class MapDataPainter : MonoBehaviour
    {
        ...
        private void PaintCorriders(OldDungeonContext _ctx)
        {
        ...
        private void PaintWalls(OldDungeonContext _ctx)
        {
        ...
        private bool IsInsideMap(OldDungeonContext ctx, Vector2Int pos)
        {
