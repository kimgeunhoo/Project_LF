...
namespace BSPDungeonGenrator
{
    ...
    {
        public void Initialize(DungeonContext ctx, RoomDistribute roomDistribute)
        {
            BuildRoomStates(ctx);
        ...
        // 방 상태 저장
        private void BuildRoomStates(DungeonContext ctx)
        {
        ...
        // 스폰 포인트 저장
        private void AssignSpawnPointsToRooms(DungeonContext ctx, List<Vector2Int> monsterSpawnPoints)
        {
